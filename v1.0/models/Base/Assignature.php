...
/**
 * Base class that represents a row from the 'assignature' table.
 *
 *
 *
 * @package    propel.generator.models.Base
 */
abstract class Assignature implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\models\\Map\\AssignatureTableMap';
    ...
    /**
     * Initializes internal state of models\Base\Assignature object.
     */
    ...
    /**
     * Compares this with another <code>Assignature</code> instance.  If
     * <code>obj</code> is an instance of <code>Assignature</code>, delegates to
     * <code>equals(Assignature)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Assignature The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AssignatureTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[AssignatureTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AssignatureTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AssignatureTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AssignatureTableMap::translateFieldName('CareerId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAssignatureQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Assignature::setDeleted()
     * @see Assignature::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAssignatureQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AssignatureTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[AssignatureTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . AssignatureTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(AssignatureTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AssignatureTableMap::COL_NAME)) {
    ...
    {
        $pos = AssignatureTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Assignature'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Assignature'][$this->hashCode()] = true;
        $keys = AssignatureTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\models\Assignature
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\models\Assignature The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(AssignatureTableMap::DATABASE_NAME);

        if ($this->isColumnModified(AssignatureTableMap::COL_ID)) {
            $criteria->add(AssignatureTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AssignatureTableMap::COL_NAME)) {
            $criteria->add(AssignatureTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(AssignatureTableMap::COL_CAREER_ID)) {
    ...
    {
        $criteria = ChildAssignatureQuery::create();
        $criteria->add(AssignatureTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \models\Assignature (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \models\Assignature Clone of current object.
     * @throws PropelException
     */
    ...
    public function setNotes(Collection $notes, ConnectionInterface $con = null)
    {
        ...
        foreach ($notesToDelete as $noteRemoved) {
            $noteRemoved->setAssignature(null);
        }
    ...
    {
        return (string) $this->exportTo(AssignatureTableMap::DEFAULT_STRING_FORMAT);
    }
