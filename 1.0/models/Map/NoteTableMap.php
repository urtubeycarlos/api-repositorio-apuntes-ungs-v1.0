...
class NoteTableMap extends TableMap
{
     ...
     */
    const COL_FILENAME = 'note.filename';

    /**
     * the column name for the extension field
     */
    const COL_EXTENSION = 'note.extension';
     ...
     */
    const COL_URL = 'note.url';

    /**
     * the column name for the assignature_id field
     */
    const COL_ASSIGNATURE_ID = 'note.assignature_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Filename', 'Extension', 'Description', 'Url', 'AssignatureId', ),
        self::TYPE_CAMELNAME     => array('id', 'filename', 'extension', 'description', 'url', 'assignatureId', ),
        self::TYPE_COLNAME       => array(NoteTableMap::COL_ID, NoteTableMap::COL_FILENAME, NoteTableMap::COL_EXTENSION, NoteTableMap::COL_DESCRIPTION, NoteTableMap::COL_URL, NoteTableMap::COL_ASSIGNATURE_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'filename', 'extension', 'description', 'url', 'assignature_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Filename' => 1, 'Extension' => 2, 'Description' => 3, 'Url' => 4, 'AssignatureId' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'filename' => 1, 'extension' => 2, 'description' => 3, 'url' => 4, 'assignatureId' => 5, ),
        self::TYPE_COLNAME       => array(NoteTableMap::COL_ID => 0, NoteTableMap::COL_FILENAME => 1, NoteTableMap::COL_EXTENSION => 2, NoteTableMap::COL_DESCRIPTION => 3, NoteTableMap::COL_URL => 4, NoteTableMap::COL_ASSIGNATURE_ID => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'filename' => 1, 'extension' => 2, 'description' => 3, 'url' => 4, 'assignature_id' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('assignature_id', 'AssignatureId', 'INTEGER', 'assignature', 'id', true, null, null);
    } // initialize()
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NoteTableMap::COL_FILENAME);
            $criteria->addSelectColumn(NoteTableMap::COL_EXTENSION);
            $criteria->addSelectColumn(NoteTableMap::COL_DESCRIPTION);
            $criteria->addSelectColumn(NoteTableMap::COL_URL);
            $criteria->addSelectColumn(NoteTableMap::COL_ASSIGNATURE_ID);
        } else {
